      ...
      {/* Container for LMP-based result */}
       ...
       {dueDate && (
        <div className="bg-green-50 p-6 rounded-2xl shadow-lg">
          <div className="mb-4">
            <p className="font-semibold text-gray-800 text-lg">Estimated LMP-Based Due Date:</p>
            <p className="text-2xl font-bold text-green-700">{dueDate}</p>
          </div>



          <div className="mt-4 bg-yellow-100 p-4 rounded">
          <h3 className="text-lg font-bold mb-2">What Now?</h3>
